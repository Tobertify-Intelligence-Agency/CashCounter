...
public sealed class AppTextService : IAppTextService
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _texts = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["savedCounts.premium.title"] = "Premium Feature",
            ["savedCounts.premium.body1"] = "Save & load counts is a premium feature.",
            ["savedCounts.premium.body2"] = "Upgrade to Premium to save your cash counts and access them later.",
            ["savedCounts.backToCounter"] = "Back to Counter",
            ["savedCounts.loading"] = "Loading saved counts...",
            ["savedCounts.empty.title"] = "No Saved Counts",
            ["savedCounts.empty.body"] = "Your saved cash counts will appear here.",
            ["savedCounts.startCounting"] = "Start Counting",
            ["savedCounts.confirmClear"] = "Are you sure you want to delete all saved counts?",
            ["savedCounts.deleteAll"] = "Delete All",
            ["savedCounts.signed"] = "Signed",
            ["savedCounts.booked"] = "Booked",
            ["savedCounts.actions"] = "Actions",
            ["savedCounts.load"] = "Load",
            ["savedCounts.sign"] = "Sign",
            ["savedCounts.book"] = "Book",
            ["savedCounts.exportPdf"] = "Export PDF",
            ["savedCounts.exportReceipt"] = "Receipt",
            ["savedCounts.signTitle"] = "Sign — {0}",
            ["savedCounts.signBody"] = "Add a signature before exporting as PDF.",
            ["savedCounts.close"] = "Close",
            ["savedCounts.signatureSaved"] = "Signature saved",
            ["savedCounts.signatureError"] = "Please add a name and a signature.",
            ["savedCounts.signer1"] = "Signer 1",
            ["savedCounts.signer2"] = "Signer 2",
            ["savedCounts.signerName"] = "Signer name",
            ["savedCounts.signerNamePlaceholder"] = "Who signed this count?",
            ["savedCounts.signerName2Placeholder"] = "Second signer (optional)",
            ["savedCounts.drawSignature"] = "Draw signature",
            ["savedCounts.clearSignature"] = "Clear",
            ["savedCounts.removeSignature"] = "Remove Signature",
            ["savedCounts.saveSignature"] = "Save Signature",
            ["savedCounts.bookTitle"] = "Book to Account Ledger",
            ["savedCounts.noAccounts"] = "No accounts set up yet. Add an account in the Account Ledger first.",
            ["savedCounts.account"] = "Account",
            ["savedCounts.selectAccount"] = "Select account",
            ["savedCounts.transactionDescriptionPlaceholder"] = "Transaction description",
            ["savedCounts.selectAccountError"] = "Please select an account.",
            ["savedCounts.confirmBooking"] = "Confirm Booking",
            ["receipt.title"] = "RECEIPT",
            ["receipt.date"] = "Date",
            ["receipt.number"] = "Receipt No.",
            ["receipt.amountReceived"] = "Amount received:",
            ["receipt.inWords"] = "In words:",
            ["receipt.paymentMethod"] = "Payment method:",
            ["receipt.cash"] = "Cash",
            ["receipt.breakdown"] = "Breakdown:",
            ["receipt.banknotes"] = "Banknotes",
            ["receipt.coins"] = "Coins",
            ["receipt.noDenominations"] = "No denominations recorded.",
            ["receipt.total"] = "Total:",
            ["receipt.signatures"] = "Signatures:",
            ["receipt.signer"] = "Signer",
            ["receipt.signed"] = "Signed",
            ["receipt.signer1Unsigned"] = "Signer 1 — not signed",
            ["receipt.signer2Unsigned"] = "Signer 2 — not signed",
            ["receipt.generatedWith"] = "Generated with CashCount",
        ...
        ["de"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["savedCounts.premium.title"] = "Premium-Funktion",
            ["savedCounts.premium.body1"] = "Zählungen speichern & laden ist eine Premium-Funktion.",
            ["savedCounts.premium.body2"] = "Upgrade auf Premium, um deine Bargeldzählungen zu speichern und später wieder aufzurufen.",
            ["savedCounts.backToCounter"] = "Zurück zum Counter",
            ["savedCounts.loading"] = "Gespeicherte Zählungen werden geladen...",
            ["savedCounts.empty.title"] = "Keine gespeicherten Zählungen",
            ["savedCounts.empty.body"] = "Deine gespeicherten Bargeldzählungen erscheinen hier.",
            ["savedCounts.startCounting"] = "Mit dem Zählen starten",
            ["savedCounts.confirmClear"] = "Möchtest du wirklich alle gespeicherten Zählungen löschen?",
            ["savedCounts.deleteAll"] = "Alle löschen",
            ["savedCounts.signed"] = "Signiert",
            ["savedCounts.booked"] = "Gebucht",
            ["savedCounts.actions"] = "Aktionen",
            ["savedCounts.load"] = "Laden",
            ["savedCounts.sign"] = "Signieren",
            ["savedCounts.book"] = "Buchen",
            ["savedCounts.exportPdf"] = "PDF exportieren",
            ["savedCounts.exportReceipt"] = "Quittung",
            ["savedCounts.signTitle"] = "Signieren — {0}",
            ["savedCounts.signBody"] = "Füge vor dem PDF-Export eine Signatur hinzu.",
            ["savedCounts.close"] = "Schließen",
            ["savedCounts.signatureSaved"] = "Signatur gespeichert",
            ["savedCounts.signatureError"] = "Bitte füge einen Namen und eine Signatur hinzu.",
            ["savedCounts.signer1"] = "Unterzeichner 1",
            ["savedCounts.signer2"] = "Unterzeichner 2",
            ["savedCounts.signerName"] = "Name des Unterzeichners",
            ["savedCounts.signerNamePlaceholder"] = "Wer hat diese Zählung unterschrieben?",
            ["savedCounts.signerName2Placeholder"] = "Zweiter Unterzeichner (optional)",
            ["savedCounts.drawSignature"] = "Signatur zeichnen",
            ["savedCounts.clearSignature"] = "Löschen",
            ["savedCounts.removeSignature"] = "Signatur entfernen",
            ["savedCounts.saveSignature"] = "Signatur speichern",
            ["savedCounts.bookTitle"] = "Ins Kontobuch buchen",
            ["savedCounts.noAccounts"] = "Es sind noch keine Konten eingerichtet. Lege zuerst im Kontobereich ein Konto an.",
            ["savedCounts.account"] = "Konto",
            ["savedCounts.selectAccount"] = "Konto auswählen",
            ["savedCounts.transactionDescriptionPlaceholder"] = "Buchungsbeschreibung",
            ["savedCounts.selectAccountError"] = "Bitte wähle ein Konto aus.",
            ["savedCounts.confirmBooking"] = "Buchung bestätigen",
            ["receipt.title"] = "QUITTUNG",
            ["receipt.fallbackName"] = "Kassenabrechnung",
            ["receipt.date"] = "Datum",
            ["receipt.number"] = "Belegnummer",
            ["receipt.amountReceived"] = "Betrag erhalten:",
            ["receipt.inWords"] = "In Worten:",
            ["receipt.paymentMethod"] = "Zahlungsart:",
            ["receipt.cash"] = "Bargeld",
            ["receipt.breakdown"] = "Aufschlüsselung:",
            ["receipt.banknotes"] = "Scheine",
            ["receipt.coins"] = "Münzen",
            ["receipt.noDenominations"] = "Keine Einzelstückelungen erfasst.",
            ["receipt.total"] = "Gesamt:",
            ["receipt.signatures"] = "Unterschriften:",
            ["receipt.signer"] = "Unterzeichner",
            ["receipt.signed"] = "Unterzeichnet",
            ["receipt.signer1Unsigned"] = "Unterzeichner 1 — nicht unterschrieben",
            ["receipt.signer2Unsigned"] = "Unterzeichner 2 — nicht unterschrieben",
            ["receipt.generatedWith"] = "Erstellt mit CashCount",
